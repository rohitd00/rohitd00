...
> Full-stack · Backend · AI systems · Developer tools

[zeniths.space](https://zeniths.space) ·
[github](https://github.com/rohitd00) · [linkedin](YOUR_LINKEDIN_URL)

------------------------------------------------------------------------

I build software that solves problems I actually find interesting.

My work mostly sits around full-stack applications, backend systems,
developer tools, and AI-powered products. I like working across the
stack --- from interfaces and product flows to APIs, databases,
background jobs, and deployment.

Most of my projects start as an idea or a problem worth solving. Some
turn into proper products, some stay experiments, and some exist simply
...
-   exploring backend architecture, distributed systems and AI-assisted
    tooling
-   turning random ideas into things that actually work
-   occasionally breaking things just to figure out why they broke

------------------------------------------------------------------------

```{=html}
<p align="center">
<samp>build · break · understand · repeat</samp>
</p>
```
